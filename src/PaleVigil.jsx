...
export const MAPS = {
  town: {
    name: "Hollow Vale", theme: "town", enc: null,
    grid: [
      "###########,,###########",
      "#..........,,..........#",
      "#.rrrr.....,,.....rrrr.#",
    ...
    exits: [ { x:11, y:0, to:"oldroad", tx:11, ty:14 }, { x:12, y:0, to:"oldroad", tx:12, ty:14 }, { x:23, y:7, to:"oldroad", tx:1, ty:7 }, { x:23, y:8, to:"oldroad", tx:1, ty:8 } ],
    doors: [ { x:3, y:4, to:"elder_house", tx:11, ty:14 }, { x:19, y:4, to:"town_shop", tx:11, ty:14 },
             { x:3, y:12, to:"vigil_hall", tx:11, ty:14 }, { x:19, y:12, to:"town_home", tx:11, ty:14 } ],
    guard: true, // can't leave without a companion
    npcs: [
      { id:"cat", x:15, y:13, creature:"grimalkin", name:"The Vale Cat",
        lines: ["...", "It regards you with luminous patience.", "It knows something. It is not telling."] },
      { id:"vill1", x:17, y:8, pal:"villager", name:"Frightened Villager",
        lines: ["Three Pale Wardens keep the old seals — woods, mire, chapel.",
                "Beat all three and the Threshold gate will open.",
                "Not that anyone's ever... you know. Come back."] },
      { id:"vill2", x:5, y:13, pal:"villager", name:"Pale Child",
        lines: ["The tall shadows whisper at night.", "They know your name. Isn't that nice?"] },
    ],
  },
  woods1: {
    name: "Ashen Woods", theme: "woods",
    enc: { rate: 0.14, lv: [4, 7], table: [["shadeling", 54], ["willowisp", 28], ["marrowmouse", 16], ["paleling", 2]] },
    grid: [
      "###########,,###########",
      "#ttt.......,,......ttt.#",
      "#tttt...##.,,.##..bttt.#",
    ...
    exits: [ { x:11, y:0, to:"woods2", tx:11, ty:14 }, { x:12, y:0, to:"woods2", tx:12, ty:14 }, { x:11, y:15, to:"ashgrove", tx:11, ty:1 }, { x:12, y:15, to:"ashgrove", tx:12, ty:1 }, { x:0, y:8, to:"orchard", tx:22, ty:8 }, { x:23, y:8, to:"oldroad", tx:11, ty:1 } ],
    npcs: [ { id:"widow", x:16, y:8, pal:"widow", name:"The Grieving Widow", trainer:"widow",
        lines: ["..."] } ],
  },
  woods2: {
    name: "Ashen Woods — Deep", theme: "woods",
    enc: { rate: 0.14, lv: [5, 8], table: [["shadeling", 44], ["willowisp", 34], ["marrowmouse", 20], ["paleling", 2]] },
    grid: [
      "###########,,###########",
      "#..........,,..........#",
      "#.tt....m..,,.......tt.#",
    ...
    gateFlag: "wren",
    exits: [ { x:11, y:0, to:"fenmoor", tx:11, ty:14 }, { x:12, y:0, to:"fenmoor", tx:12, ty:14 }, { x:11, y:15, to:"woods1", tx:11, ty:1 }, { x:12, y:15, to:"woods1", tx:12, ty:1 } ],
    npcs: [
      { id:"burner", x:6, y:5, pal:"villager", name:"The Charcoal Burner", trainer:"burner", lines:["..."] }, { id:"wren", x:14, y:3, pal:"wren", name:"Mother Wren", trainer:"wren", lines: ["..."] } ],
  },
  mire1: {
    name: "The Weeping Mire", theme: "mire",
    enc: { rate: 0.15, lv: [11, 15], table: [["bloodfly", 34], ["hexen", 24], ["vespire", 24], ["marrowmouse", 16], ["paleling", 2]] },
    grid: [
      "###########,,###########",
      "#..ww......,,tt....ww..#",
      "#.wwww.....ttttt..wwww.#",
    ...
    exits: [ { x:11, y:0, to:"mire2", tx:11, ty:14 }, { x:12, y:0, to:"mire2", tx:12, ty:14 }, { x:11, y:15, to:"fenmoor", tx:11, ty:1 }, { x:12, y:15, to:"fenmoor", tx:12, ty:1 }, { x:23, y:7, to:"mire2", tx:1, ty:7 }, { x:23, y:8, to:"mire2", tx:1, ty:8 }, { x:0, y:7, to:"hamlet", tx:22, ty:7 }, { x:0, y:8, to:"hamlet", tx:22, ty:8 } ],
    npcs: [ { id:"bog", x:6, y:7, pal:"bog", name:"The Bogwalker", trainer:"bog", lines: ["..."] } ],
  },
  mire2: {
    name: "The Weeping Mire — Sunken Yard", theme: "mire",
    enc: { rate: 0.15, lv: [12, 16], table: [["bloodfly", 30], ["hexen", 28], ["vespire", 26], ["mirelurch", 14], ["paleling", 2]] },
    grid: [
      "###########,,###########",
      "#..........,,..........#",
      "#.ww.......,,.......ww.#",
    ...
    gateFlag: "sol",
    exits: [ { x:11, y:0, to:"vesperrest", tx:11, ty:14 }, { x:12, y:0, to:"vesperrest", tx:12, ty:14 }, { x:11, y:15, to:"mire1", tx:11, ty:1 }, { x:12, y:15, to:"mire1", tx:12, ty:1 }, { x:0, y:7, to:"mire1", tx:22, ty:7 }, { x:0, y:8, to:"mire1", tx:22, ty:8 } ],
    npcs: [
      { id:"leechfarmer", x:17, y:5, pal:"bog", name:"The Leech Farmer", trainer:"leechfarmer", lines:["..."] }, { id:"sol", x:13, y:3, pal:"sol", name:"Gravekeeper Sol", trainer:"sol", lines: ["..."] } ],
  },
  chapel: {
    name: "The Bone Chapel", theme: "chapel",
    enc: { rate: 0.15, lv: [17, 21], table: [["choirling", 32], ["hexen", 22], ["ossari", 22], ["grimalkin", 22], ["paleling", 2]] },
    grid: [
      "###########,,###########",
      "#..........,,.......n..#",
      "#.====n....,,.....====.#",
    ...
    gateFlag: "choir",
    exits: [ { x:11, y:0, to:"palegate", tx:11, ty:14 }, { x:12, y:0, to:"palegate", tx:12, ty:14 }, { x:11, y:15, to:"vesperrest", tx:11, ty:1 }, { x:12, y:15, to:"vesperrest", tx:12, ty:1 }, { x:23, y:7, to:"shallows", tx:1, ty:7 } ],
    npcs: [ { id:"acolyte", x:6, y:9, pal:"acolyte", name:"The Acolyte", trainer:"acolyte", lines: ["..."] },
            { id:"choir", x:13, y:2, pal:"choir", name:"The Choirmaster", trainer:"choir", lines: ["..."] } ],
  },
  threshold: {
    name: "The Threshold", theme: "threshold", gateFlag: "king",
    enc: { rate: 0.13, lv: [22, 25], table: [["ossari", 28], ["choirling", 18], ["hexen", 16], ["cindermaw", 22], ["grimalkin", 14], ["paleling", 2]] },
    grid: [
      "###########XX###########",
      "#..........,,..........#",
      "#.....##..#..#..##.....#",
    ...
    exits: [ { x:11, y:0, to:"court", tx:11, ty:14 }, { x:12, y:0, to:"court", tx:12, ty:14 }, { x:11, y:15, to:"lastlantern", tx:11, ty:1 }, { x:12, y:15, to:"lastlantern", tx:12, ty:1 }, { x:0, y:7, to:"underveil", tx:1, ty:7 }, { x:0, y:8, to:"underveil", tx:1, ty:8 } ],
    npcs: [ { id:"king", x:12, y:1, pal:"king", name:"The Hollow King", trainer:"king", lines: ["..."] } ],
  },
  orchard: {
    name: "Withered Orchard", theme: "woods",
    enc: { rate: 0.15, lv: [5, 9], table: [["willowisp", 40], ["marrowmouse", 30], ["shadeling", 28], ["paleling", 2]] },
    grid: [
      "########################",
      "#..tt......#......tt...#",
      "#..tt..#.......#..ttb..#",
    ...
    exits: [ { x:23, y:7, to:"woods1", tx:1, ty:8 }, { x:23, y:8, to:"woods1", tx:1, ty:8 } ],
    npcs: [ { id:"keeper", x:6, y:3, pal:"villager", name:"The Orchard Keeper", trainer:"keeper", lines: ["..."] } ],
  },
  shallows: {
    name: "The Drowned Shallows", theme: "mire",
    enc: { rate: 0.15, lv: [18, 22], table: [["vespire", 30], ["mirelurch", 28], ["hexen", 20], ["grimalkin", 20], ["paleling", 2]] },
    grid: [
      "########################",
      "#..ww......wwm.....ww..#",
      "#.wwww.n..wwww....wwww.#",
    ...
    exits: [ { x:0, y:7, to:"chapel", tx:22, ty:7 }, { x:0, y:8, to:"chapel", tx:22, ty:7 } ],
    npcs: [ { id:"sister", x:16, y:8, pal:"widow", name:"The Drowned Sister", trainer:"sister", lines: ["..."] } ],
  },
  oldroad: {
    name: "The Old Road", theme: "town",
    enc: { rate: 0.13, lv: [3, 6], table: [["shadeling", 50], ["willowisp", 24], ["marrowmouse", 24], ["paleling", 2]] },
    grid: [
      "###########,,###########",
      "#..=====...,,...=====..#",
      "#..........,,..........#",
    ...
    exits: [ { x:11, y:0, to:"ashgrove", tx:11, ty:14 }, { x:12, y:0, to:"ashgrove", tx:12, ty:14 }, { x:11, y:15, to:"town", tx:11, ty:1 }, { x:12, y:15, to:"town", tx:12, ty:1 } ],
    npcs: [ { id:"peddler", x:16, y:5, pal:"villager", name:"The Wandering Peddler",
        lines: ["Charms, friend. The shop in the Vale sells charms now — rings, fangs, talismans.",
                "A Dread holding the right charm fights like two Dreads.",
                "I'd sell you one myself, but something ate my cart."] } ],
  },
  hamlet: {
    ...
    exits: [ { x:23, y:7, to:"mire1", tx:1, ty:7 }, { x:23, y:8, to:"mire1", tx:1, ty:8 },
             { x:11, y:0, to:"gravemarch", tx:11, ty:14 }, { x:12, y:0, to:"gravemarch", tx:12, ty:14 } ],
    doors: [ { x:4, y:3, to:"hamlet_home1", tx:11, ty:14 }, { x:18, y:3, to:"hamlet_home2", tx:11, ty:14 } ],
    npcs: [
      { id:"hamlet_elder", x:16, y:6, pal:"elder", name:"Hamlet Elder",
        lines: ["Emberfall, we're called. We lit our lamps from the Vigil Flame itself, once.",
                "The night it died, every lamp in the hamlet went out at the same breath.",
                "Old Marn saw something that night. Ask him. First house, west side."] },
      { id:"muddy_kid", x:6, y:13, pal:"villager", name:"Muddy Child",
        lines: ["The graves north of here hum when you put your ear on them.", "Mama says don't. So obviously I did.", "They hum a NAME."] },
    ],
  },
  gravemarch: {
    name: "Gravemarch Fields", theme: "woods",
    enc: { rate: 0.15, lv: [10, 14], table: [["marrowmouse", 38], ["gravepup", 22], ["shadeling", 20], ["hexen", 18], ["paleling", 2]] },
    grid: [
      "########################",
      "#..G..tt...,,t...G.....#",
      "#.....tt....tt.........#",
    ...
    exits: [ { x:11, y:15, to:"hamlet", tx:11, ty:1 }, { x:12, y:15, to:"hamlet", tx:12, ty:1 } ],
    npcs: [
      { id:"bonepicker", x:17, y:6, pal:"widow", name:"The Bone Picker", trainer:"bonepicker", lines:["..."] }, { id:"mourner", x:16, y:4, pal:"widow", name:"The Gravemarch Mourner", trainer:"mourner", lines: ["..."] },
            { id:"dozer", x:6, y:11, creature:"gravepup", name:"Dozing Gravepup",
              lines: ["It sleeps atop an old grave, tail thumping.", "It is dreaming of someone.", "The someone under the stone."] } ],
  },
  underveil: {
    name: "Underveil Passage", theme: "cave",
    enc: { rate: 0.15, lv: [23, 26], table: [["cindermaw", 30], ["ossari", 26], ["grimalkin", 22], ["hexen", 20], ["paleling", 2]] },
    grid: [
      "###########,,###########",
      "#...tt.....,,..tt......#",
      "#...tt....##...tt......#",
    ...
    exits: [ { x:11, y:0, to:"lastlantern", tx:11, ty:14 }, { x:12, y:0, to:"lastlantern", tx:12, ty:14 }, { x:11, y:15, to:"palegate", tx:11, ty:1 }, { x:12, y:15, to:"palegate", tx:12, ty:1 }, { x:0, y:7, to:"threshold", tx:1, ty:7 }, { x:0, y:8, to:"threshold", tx:1, ty:8 } ],
    npcs: [
      { id:"reject", x:6, y:11, pal:"acolyte", name:"Kingsguard Reject", trainer:"reject", lines:["..."] }, { id:"hollowacolyte", x:16, y:4, pal:"acolyte", name:"The Hollow Acolyte", trainer:"hollowacolyte", lines: ["..."] } ],
  },
  behindveil: {
    name: "Behind the Veil", theme: "veil",
    enc: { rate: 0.16, lv: [26, 30], table: [["paleling", 10], ["grimalkin", 20], ["hemolich", 15], ["duskveil", 10], ["cindermaw", 15], ["ossari", 15], ["hexen", 15]] },
    grid: [
      "########################",
      "#...........c.....m....#",
      "#....................m.#",
    ...
    exits: [ { x:11, y:15, to:"court", tx:11, ty:1 }, { x:12, y:15, to:"court", tx:12, ty:1 } ],
    npcs: [ { id:"firstwarden", x:13, y:1, pal:"choir", name:"The First Warden",
        lines: ["You can see me. Good. Then the Flame truly chose you.",
                "I kept the first Vigil, four hundred years ago. And I am the one who failed it.",
                "The Hollow King... wore my face, once. I opened the gate from the inside — just a crack. Just to see.",
                "The dark does not break in, Warden. It is INVITED. Remember that, when you light the lamps.",
                "The Dreads that drift here are the oldest and the strangest. Bind what you can.",
                "And the pale ones — they gather thick on this side. They were people, once. Be gentle."] } ],
  },
  elder_house: {
    ...
    exits: [ { x:11, y:15, to:"town", tx:3, ty:5 }, { x:12, y:15, to:"town", tx:3, ty:5 } ],
  ...
  town_shop: {
    ...
    exits: [ { x:11, y:15, to:"town", tx:19, ty:5 }, { x:12, y:15, to:"town", tx:19, ty:5 } ],
    npcs: [
  ...
  vigil_hall: {
    ...
    exits: [ { x:11, y:15, to:"town", tx:3, ty:13 }, { x:12, y:15, to:"town", tx:3, ty:13 } ],
  ...
  town_home: {
    ...
    exits: [ { x:11, y:15, to:"town", tx:19, ty:13 }, { x:12, y:15, to:"town", tx:19, ty:13 } ],
  ...
  hamlet_home1: {
    ...
    exits: [ { x:11, y:15, to:"hamlet", tx:4, ty:4 }, { x:12, y:15, to:"hamlet", tx:4, ty:4 } ],
  ...
  hamlet_home2: {
    ...
    exits: [ { x:11, y:15, to:"hamlet", tx:18, ty:4 }, { x:12, y:15, to:"hamlet", tx:18, ty:4 } ],
  ...
  ashgrove: {
    ...
    exits: [ { x:11, y:0, to:"woods1", tx:11, ty:14 }, { x:12, y:0, to:"woods1", tx:12, ty:14 }, { x:11, y:15, to:"oldroad", tx:11, ty:1 }, { x:12, y:15, to:"oldroad", tx:12, ty:1 },  ],
    doors: [ { x:3, y:2, to:"ash_hall", tx:11, ty:14 }, { x:19, y:6, to:"ash_home", tx:11, ty:14 } ],
    signs: [ { x:9, y:12, lines: ["ASHGROVE", "First town of the north road.", "The Guard watches. The Guard burns."] } ],
    npcs: [ { id:"ag1", x:6, y:10, pal:"villager", name:"Charred Farmer",
        lines: ["The grove burned the night the King took the road.", "Sister Ash lit the fire herself. To deny him the timber, she says.", "She holds the Cinder Seal in the great hall. She will not hand it over kindly."] },
      { id:"ag2", x:17, y:13, pal:"villager", name:"Ashgrove Child",
        lines: ["Sister Ash never blinks.", "I counted. A whole hour. Zero blinks."] } ],
  },
  ash_hall: {
    ...
    exits: [ { x:11, y:15, to:"ashgrove", tx:10, ty:4 }, { x:12, y:15, to:"ashgrove", tx:10, ty:4 } ],
  ...
  ash_home: {
    ...
    exits: [ { x:11, y:15, to:"ashgrove", tx:18, ty:8 }, { x:12, y:15, to:"ashgrove", tx:18, ty:8 } ],
  ...
  fenmoor: {
    ...
    exits: [ { x:11, y:0, to:"mire1", tx:11, ty:14 }, { x:12, y:0, to:"mire1", tx:12, ty:14 }, { x:11, y:15, to:"woods2", tx:11, ty:1 }, { x:12, y:15, to:"woods2", tx:12, ty:1 },  ],
    doors: [ { x:3, y:3, to:"fen_hall", tx:11, ty:14 }, { x:19, y:4, to:"fen_home", tx:11, ty:14 } ],
    signs: [ { x:9, y:11, lines: ["FENMOOR", "Stilt-town at the mire edge.", "Do not feed the water."] } ],
    npcs: [ { id:"fm1", x:6, y:10, pal:"bog", name:"Stilt Carpenter",
        lines: ["Gravekeeper Sol keeps Fenmoor now. Buried half the town, dug up the other half.", "He says the King promised the dead would keep. Sol checks. Nightly."] },
      { id:"fm2", x:5, y:1, pal:"villager", name:"Fenmoor Girl",
        lines: ["The mire past the north gate drinks whatever it is given.", "It is thirsty. It is ALWAYS thirsty."] } ],
  },
  fen_hall: {
    name: "Guard Hall", theme: "interior", enc: null,
    grid: [
    ...
    exits: [ { x:11, y:15, to:"fenmoor", tx:10, ty:4 }, { x:12, y:15, to:"fenmoor", tx:10, ty:4 } ],
  ...
  fen_home: {
    ...
    exits: [ { x:11, y:15, to:"fenmoor", tx:18, ty:8 }, { x:12, y:15, to:"fenmoor", tx:18, ty:8 } ],
  ...
  vesperrest: {
    ...
    exits: [ { x:11, y:0, to:"chapel", tx:11, ty:14 }, { x:12, y:0, to:"chapel", tx:12, ty:14 }, { x:11, y:15, to:"mire2", tx:11, ty:1 }, { x:12, y:15, to:"mire2", tx:12, ty:1 },  ],
    doors: [ { x:8, y:2, to:"vesper_hall", tx:11, ty:14 }, { x:19, y:12, to:"vesper_home", tx:11, ty:14 } ],
    signs: [ { x:9, y:11, lines: ["VESPER REST", "The bells ring themselves.", "Attendance is noted."] } ],
    npcs: [ { id:"vr1", x:6, y:10, pal:"acolyte", name:"Deaf Bellringer",
        lines: ["I rang the vespers forty years. Then the Choirmaster came and the bells learned to ring alone.", "He holds the Hymn Seal in the hall. He will want you to sing for it.", "You will not like the song."] },
      { id:"vr2", x:17, y:13, pal:"villager", name:"Humming Child",
        lines: ["Hmm hmm hmmm... hm hm...", "(You do not recognize the tune. Your Dreads do. They are very still.)"] } ],
  },
  vesper_hall: {
    name: "Guard Hall", theme: "interior", enc: null,
    grid: [
    ...
    exits: [ { x:11, y:15, to:"vesperrest", tx:10, ty:4 }, { x:12, y:15, to:"vesperrest", tx:10, ty:4 } ],
  ...
  vesper_home: {
    ...
    exits: [ { x:11, y:15, to:"vesperrest", tx:18, ty:8 }, { x:12, y:15, to:"vesperrest", tx:18, ty:8 } ],
  ...
  palegate: {
    ...
    exits: [ { x:11, y:0, to:"underveil", tx:11, ty:14 }, { x:12, y:0, to:"underveil", tx:12, ty:14 }, { x:11, y:15, to:"chapel", tx:11, ty:1 }, { x:12, y:15, to:"chapel", tx:12, ty:1 },  ],
    doors: [ { x:5, y:3, to:"pale_hall", tx:11, ty:14 }, { x:5, y:12, to:"pale_home", tx:11, ty:14 } ],
    signs: [ { x:9, y:11, lines: ["PALEGATE", "The chalk gate of the high country.", "The Knight does not lift the visor."] } ],
    npcs: [ { id:"pg1", x:1, y:1, pal:"villager", name:"Chalk Miner",
        lines: ["The Pale Knight took the gate without a single battle. Folk just... stepped aside.", "Nobody has seen the face. There are wagers. There are theories.", "My theory: there is no face."] },
      { id:"pg2", x:17, y:13, pal:"widow", name:"Palegate Seamstress",
        lines: ["I mended the cloak of the Knight once. The cold coming off it put frost on my needle.", "Paid in old coins, though. Older than the town. Older than the KING."] } ],
  },
  pale_hall: {
    name: "Guard Hall", theme: "interior", enc: null,
    grid: [
    ...
    exits: [ { x:11, y:15, to:"palegate", tx:10, ty:4 }, { x:12, y:15, to:"palegate", tx:10, ty:4 } ],
  ...
  pale_home: {
    ...
    exits: [ { x:11, y:15, to:"palegate", tx:18, ty:8 }, { x:12, y:15, to:"palegate", tx:18, ty:8 } ],
  ...
  lastlantern: {
    ...
    exits: [ { x:11, y:0, to:"threshold", tx:11, ty:14 }, { x:12, y:0, to:"threshold", tx:12, ty:14 }, { x:11, y:15, to:"underveil", tx:11, ty:1 }, { x:12, y:15, to:"underveil", tx:12, ty:1 },  ],
    doors: [ { x:3, y:2, to:"lantern_hall", tx:11, ty:14 }, { x:3, y:12, to:"lantern_home", tx:11, ty:14 } ],
    signs: [ { x:18, y:8, lines: ["LAST LANTERN", "One lamp still lit.", "Guard it with your teeth."] } ],
    npcs: [ { id:"ll1", x:6, y:10, pal:"elder", name:"Lantern Keeper",
        lines: ["Every lamp in the kingdom went out. Ours did not. We do not know why.", "The Hand of the King lives in our hall and watches our lantern burn, and smiles, and does NOTHING.", "That is somehow the most frightening thing it does."] },
      { id:"ll2", x:17, y:13, pal:"villager", name:"Last Villager",
        lines: ["Beyond the north gate is the Threshold. Beyond the Threshold, the Court.", "Nobody comes back down the road. You look like you might.", "Come back down the road."] } ],
  },
  lantern_hall: {
    name: "Guard Hall", theme: "interior", enc: null,
    grid: [
    ...
    exits: [ { x:11, y:15, to:"lastlantern", tx:10, ty:4 }, { x:12, y:15, to:"lastlantern", tx:10, ty:4 } ],
  ...
  lantern_home: {
    ...
    exits: [ { x:11, y:15, to:"lastlantern", tx:17, ty:8 }, { x:12, y:15, to:"lastlantern", tx:17, ty:8 } ],
  ...
  court: {
    ...
    exits: [ { x:11, y:0, to:"behindveil", tx:11, ty:14 }, { x:12, y:0, to:"behindveil", tx:12, ty:14 }, { x:11, y:15, to:"threshold", tx:11, ty:1 }, { x:12, y:15, to:"threshold", tx:12, ty:1 } ],
    npcs: [ { id:"king", x:12, y:2, pal:"king", name:"The Hollow King", trainer:"king", lines: ["..."] } ],
  },
};


// ---------- ambient life, treasures, and signs ----------
MAPS.town.items = [ { x:2, y:14, id:"embers", qty:60 } ];
MAPS.oldroad.items = [ { x:3, y:12, id:"salve", qty:2 }, { x:21, y:3, id:"sigil", qty:2 } ];
MAPS.woods1.items = [ { x:2, y:7, id:"salve", qty:2 } ];
MAPS.woods2.items = [ { x:21, y:5, id:"sigil", qty:3 } ];
MAPS.orchard.items = [ { x:2, y:14, id:"gsalve", qty:1 }, { x:20, y:6, id:"embers", qty:120 } ];
MAPS.mire1.items = [ { x:16, y:5, id:"gsalve", qty:1 }, { x:2, y:13, id:"embers", qty:150 } ];
MAPS.mire2.items = [ { x:21, y:4, id:"incense", qty:2 } ];
MAPS.hamlet.items = [ { x:20, y:13, id:"embers", qty:90 } ];
MAPS.gravemarch.items = [ { x:3, y:4, id:"gsigil", qty:2 }, { x:17, y:8, id:"embers", qty:200 } ];
MAPS.chapel.items = [ { x:2, y:3, id:"gsalve", qty:2 } ];
MAPS.shallows.items = [ { x:20, y:13, id:"leechfang", qty:1 }, { x:2, y:4, id:"embers", qty:250 } ];
MAPS.underveil.items = [ { x:20, y:12, id:"ironvigil", qty:1 }, { x:3, y:13, id:"gsalve", qty:2 } ];
MAPS.threshold.items = [ { x:2, y:12, id:"gsigil", qty:3 } ];
MAPS.behindveil.items = [ { x:2, y:2, id:"cursedeye", qty:1 }, { x:21, y:10, id:"embers", qty:666 } ];
MAPS.town.signs = [ { x:9, y:14, lines: ["HOLLOW VALE — pop. 312", "(the 312 is crossed out: 311)", "(the 311 is crossed out: 309)"] } ];
MAPS.woods1.signs = [ { x:14, y:14, lines: ["ASHEN WOODS", "The grass watches back."] } ];
MAPS.hamlet.signs = [ { x:14, y:13, lines: ["EMBERFALL HAMLET", "Lamps out since the Falling. We light them anyway."] } ];
MAPS.chapel.signs = [ { x:14, y:14, lines: ["THE BONE CHAPEL", "Services: eternal. Attendance: mandatory, eventually."] } ];
MAPS.oldroad.signs = [ { x:9, y:13, lines: ["THE OLD ROAD", "Travel in pairs. Or not at all."] } ];
MAPS.threshold.signs = [ { x:14, y:13, lines: ["THE THRESHOLD", "TURN BACK", "(carved beneath, smaller): please"] } ];
MAPS.woods1.amb = [{k:'crow',x:5,y:3},{k:'crow',x:18,y:11}];
MAPS.woods2.amb = [{k:'crow',x:4,y:6},{k:'crow',x:19,y:10}];
MAPS.orchard.amb = [{k:'crow',x:9,y:2},{k:'crow',x:17,y:12}];
MAPS.gravemarch.amb = [{k:'crow',x:8,y:2},{k:'crow',x:14,y:10}];
MAPS.oldroad.amb = [{k:'crow',x:5,y:10}];
MAPS.mire1.amb = [{k:'wisp',x:4,y:2},{k:'wisp',x:18,y:10}];
MAPS.mire2.amb = [{k:'wisp',x:3,y:12},{k:'wisp',x:20,y:3}];
MAPS.shallows.amb = [{k:'wisp',x:3,y:2},{k:'wisp',x:19,y:11},{k:'wisp',x:12,y:13}];
MAPS.chapel.amb = [{k:'mote',x:5,y:3},{k:'mote',x:18,y:9}];
MAPS.threshold.amb = [{k:'mote',x:5,y:10},{k:'mote',x:18,y:4}];
MAPS.behindveil.amb = [{k:'mote',x:6,y:6},{k:'mote',x:17,y:11},{k:'wisp',x:12,y:5}];
MAPS.underveil.amb = [{k:'bat',x:7,y:3},{k:'bat',x:16,y:11}];
...
export default function PaleVigil() {
  ...
  useEffect(() => {
    ...
    const render = (now) => {
      ...
      const ctx = cv.getContext("2d");
      const VW = 192, VH = 128;
      const camX = clamp(A.x * 16 + 8 - VW / 2, 0, 384 - VW);
      const camY = clamp(A.y * 16 + 8 - VH / 2, 0, 256 - VH);
  ...
  function MenuMap() {
    ...
    useEffect(() => {
      ...
      for (const [id, [px, py]] of Object.entries(POS)) {
        ...
        for (let y = 0; y < 16; y++) for (let x = 0; x < 24; x++) {
          ctx.fillStyle = tileColor(th, m.grid[y][x]); ctx.fillRect(px + x * 2.5, py + y * 1.25, 2.5, 1.25);
        }
